...
function CommercialZone() {
    ...
    const shops = useMemo(
        () => [
            { pos: [5, 0, -2], size: [2, 1.8, 2], color: '#c4956a' },
            { pos: [8, 0, -2], size: [2.5, 2, 2], color: '#d4a574' },
            { pos: [11, 0, -2], size: [1.8, 1.5, 2], color: '#b88555' },
            { pos: [5, 0, -5], size: [2, 2.2, 2.5], color: '#c4956a' },
            { pos: [8, 0, -5], size: [2, 1.6, 2], color: '#d4a574' },
            { pos: [11, 0, -5], size: [2.2, 2, 2], color: '#b88555' },
            { pos: [14, 0, -3], size: [1.8, 1.8, 2.5], color: '#c4956a' },
        ],
        []
    )
    ...
    return (
        <group scale={[scale, 1, scale]}>
            ...
            <mesh rotation={[-Math.PI / 2, 0, 0]} position={[9, 0.02, -3.5]}>
            ...
            {Array.from({ length: 5 }).map((_, i) => (
                <group key={`stall-${i}`} position={[5 + i * 2, 0, 0.5]}>
